...
* `latest` [(jareddlc/jenkins-with-docker-socket/Dockerfile)](../master/Dockerfile)
* `2.60.3-alpine` [(jareddlc/jenkins-with-docker-socket/2.60.3-alpine/Dockerfile)](../master/2.60.3-alpine/Dockerfile)
